...
exports.notiticationHelpers = exports.notificationsValidations = void 0;
const notificationsValidations = {
    ...
    **/
     ...
     * @returns {boolean}
     * */
    validarMensaje(msg, minLenght = 3) {
    ...
    validarTimeStamp(timestamp) {
        if (!timestamp)
            return false;
        const fecha = timestamp, instanceOf, Date, timestamp;
        ();
...
exports.notificationsValidations = notificationsValidations;
...
const notiticationHelpers = {
    ...
    * */
    validarAntesDeEscucha(role, uid) {
     ...
     * @params {notifyId^uid } = (Identificador unico de la notificacion^ UID del alumno[obligatorio])
     * @returns  No regresa nada si se cumplen las condiciones **/
    validarAntesMarcarLeido(role, notifyId, uid) {
        if (notificationsValidations.validarRole(role))
    ...
    /**
      ...
      * @params {uidList msge} = (lista UIDs de los destinatarios contenido del msga enviar)
      * @returns  No regresa nada si se cumplen las condiciones **/
    validarAntesDeEnviar(role, uidList, msge) {
        if (notificationsValidations.validarRole(role)) {
...
exports.notiticationHelpers = notiticationHelpers;
/*
...
//# sourceMappingURL=validationsNotifications.js.map