// "use strict";
// import { defineStore } from 'pinia'; // Usa 'import' en lugar de 'require'
// import { MaterialDeployService } from '@/services/MaterialAdmServAlumno.js'; // Usamos 'import' para los servicios
...
//     materialById: (state) => {
//       return (id) => state.materials.find((m) => m.id === id) || null;
//     }
//   },
...
//       this.cleanError();
//       try {
//         const materials = await MaterialDeployService.getAllMaterialsEduc();
...
//     async guardarMaterialesYActualizar(material) {
//       this.loading = true;
//       this.cleanError();
//       try {
...
//     async guardarMateriales(material) {
//       this.loading = true;
//       this.cleanError();
//       try {
//         const resultado = await MaterialDeployService.saveMatererials(material);
//         if (resultado) {
//           console.log('El guardado del material fue exitoso');
//         } else {
//           console.log('No se guardó el material. Verifica la selección.');
//         }
//       } catch (err) {
//         this.setError(err.message);
//       } finally {
...
//     async eliminarLosMateriales(id) {
//       this.loading = true;
//       this.cleanError();
//       try {
...
//    /* module.exports = useMaterialStore;*/

// /*"use strict";
// Object.defineProperty(exports, "__esModule", { value: true });
// const pinia_1 = require("pinia");
// const MaterialServ_js_1 = require("@/services/MaterialServ.js");
...
//     const useMaterialStore = (0, pinia_1.defineStore)('material', {
//         state: () => ({
//             materials: [],
//             loading: false,
//             error: "",
...
//                   this.cleanError();
//            	   	 	   try{
//                         this.setMaterials(await MaterialDeployService.getAllMaterialsEduc());
//            	   	 	   }catch(err: any){
