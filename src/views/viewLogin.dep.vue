	...
	<div class="auth_view_pnl">
		<form  @submit.prevent="handleLogin" class="auth_form">
			...
			<div class="botones">
				...
				<button type="button"  @click="anunciarUsuario" :disabled="loading || isAuthenticated" >
				  Mostrar Perfil
				</button>
			</div>
		</form>
	 ...
	 const userSession = ref<User | null>(null);
       ...
       * */
        ...
        /*Funciones auxiliares para tener una experiencia amigable*/
          ...
          /*function siRequiereAnunciarUser(argument) { // Lógica de la...
          	// Mostra nombre completo: nombre, apellido hora de sesion y carrera return  !isAuthenticated.value; }*/
</script>
   <style>
   		.auth_view_pnl{
   			max-width: 720px;
