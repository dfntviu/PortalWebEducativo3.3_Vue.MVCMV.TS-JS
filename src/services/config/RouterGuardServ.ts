...
import {PermissionsService} from '@/services/PermissionsServ.ts';  /** Clase de permisos segun su Rol **/
    ...
    export class RouterGuardService {
    	 ...
    	 constructor(private role: Role){
    	  ...
    	  async globalGuard(to: RouteLocationNormalized, from: RouteLocationNormalized, next: NavigationGuardNext){
    	 	 ...
    	 	 if (to.meta.requieresAuth && to.meta auth_store.isAuthenticated) { //not 
