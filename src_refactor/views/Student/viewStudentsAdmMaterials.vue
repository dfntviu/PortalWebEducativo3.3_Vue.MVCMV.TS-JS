		...
		<div class="max-w-7xl">
			...
			<div class="bg-white">
				...
				<div class="mt-4 p-4 bg-red-50">
					...
					<div class="space-y-4">
						<div class="bg-white gray-800 rounded-2xl">
							<div class="inline-block w-16 h-16">
								<p class="mt-4 text-gray-600">Cargando Materiales..</p>
									<!-- Empty State -->
								<div class="bg-white roundex-2xl shadow-xl p-12 text-center">
									<div class="text-8xl mb-4">📭</div>
									<h3 class="text-2xl">{{getEmptyMessage()}}</h3>
									<p class="text-gray-100 dark:text-gray-400 mb-6"></p>
									<button class="px-6 py-3 bg-indigo-600 text-white-rounde-lg"
...
<script lang="ts">
	...
	import {useAuthStoref} from '@/stores/authStoref.ts';
