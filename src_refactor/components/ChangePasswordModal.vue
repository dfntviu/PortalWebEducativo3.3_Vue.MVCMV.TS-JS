 	 					   ...
 	 					   <div v-if="passwordForm.newPassword" class="validacion-fortaleza">
 	 					   	...
 	 					   	<div class="criterios-validacion">
 	 					   		<div class="criterio" :class=" {
 	 					   			...
 	 					   			<span class="icono"> {{passworForm.newPassword.length >= 8 ? '✓' :  '○'  }}</span>al menos 8 caracteres
 	 					   		</div>
 	 					   		<div class="criterio"
 	 					   	   ...
 	 					   	   <div class="criterio"
  									   :class=" { valido: passwordForm.newPassword !== password.currentPassword } " 
 	 					   	    >
 	 					   	   	    <span class="icono">
 	 					   	           {{ valido: passwordForm.newPassword !== password.currentPassword '✓' :  '○' }}
...
<script setup lang="ts">
   ...
   // ═══════════════════════════════════════
	...
	// ════════════════════════════════════════════════
	 const tieneNumeros = computed(() =>  /\d/.test(passworForm.newPassword));
	 const tieneMAyusculas = computed(() => /[A-Z]/.test(passworForm.newPassword));
